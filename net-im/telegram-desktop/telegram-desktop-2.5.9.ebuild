...
SLOT="0"
KEYWORDS="amd64"
IUSE="+dbus enchant +gtk +hunspell lto pulseaudio +spell wayland +X +toxi" # +webrtc 
...
RDEPEND="
	...
	~media-libs/tg_owt-0_pre20210124[pulseaudio]
"
...
#	use webrtc || local PATCHES=( "${FILESDIR}/no-webrtc-build.patch" )
	...
	sed -e 's/DESKTOP_APP_USE_PACKAGED/NO_ONE_WILL_EVER_SET_THIS/' -i cmake/external/rlottie/CMakeLists.txt || die
